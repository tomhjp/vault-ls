...
import (
	...
	"github.com/tomhjp/vault-ls/internal/protocol"
	"github.com/tomhjp/vault-ls/internal/source"
)
...
func TestTokenEncoder_singleLineTokens(t *testing.T) {
  ...
  bool_attr = true
	...
	te := &TokenEncoder{
		Lines: source.MakeSourceLines("test.vault-server", bytes),
		Tokens: []lang.SemanticToken{
			{
				Type: lang.TokenBlockType,
				Range: hcl.Range{
					Filename: "test.vault-server",
